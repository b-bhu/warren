...
function TabIcon({ color, focused, name }: { color: string; focused: boolean; name: TabIconName }) {
  ...
  return (
    <View style={[styles.icon, { backgroundColor: focused ? theme.proofWash : 'transparent' }]}>
...
const styles = StyleSheet.create({
  icon: { alignItems: 'center', borderRadius: 999, height: 30, justifyContent: 'center', width: 58 },
});
